import pandas as pd
#fileIN='EGMS_L3_E43N22_100km_U_2018_2022_1/EGMS_L3_E43N22_100km_U_2018_2022_1.csv'
...
fig.plot(x=df['lon'], y=df['lat'], style="s.1c", fill="seagreen")
